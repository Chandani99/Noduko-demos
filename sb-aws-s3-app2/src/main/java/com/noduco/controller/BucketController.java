...
import com.noduco.service.BucketService;
...
public class BucketController {
	...
	public ResponseEntity<String> uploadFile(@RequestParam MultipartFile file,
		...
		service.uploadFiletoBucket(file,bucketName);
	...
	{
		service.deletFile(bucketName,fileName);
	...
	public ResponseEntity<String> deleteBucket(@PathVariable String bucketName) {
		...
		return new ResponseEntity<>("Bucket deleted sucefully", HttpStatus.OK);
	}
